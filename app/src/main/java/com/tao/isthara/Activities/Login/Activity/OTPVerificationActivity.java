...
public class OTPVerificationActivity extends AppCompatActivity implements
    ...
    void initiateVerification(boolean skipPermissionCheck) {
        ...
        if (intent != null) {
            String phoneNumber = intent.getStringExtra(LoginActivity.INTENT_PHONENUMBER);
            String countryCode = intent.getStringExtra(LoginActivity.INTENT_COUNTRY_CODE);
    ...
    void showCompleted(String response) {
        View container = findViewById(R.id.inputContainer);
        container.setVisibility(View.GONE);
    ...
    private void startTimer() {
        ...
        new CountDownTimer(30000, 1000) {
            ...
            public void onFinish() {
                ...
                resend_timer.setTextColor(ContextCompat.getColor(OTPVerificationActivity.this, R.color.colorPrimaryDark));
            }
        }.start();
    }
